...
model.save_model('/content/drive/My Drive/Deep Learning/Saved Models/Spirals/spiral2.h5')

model1 = Model(X_tr,y_tr,X_te,y_te,X_cv,y_cv)

model1.load_model('/content/drive/My Drive/Deep Learning/Saved Models/Spirals/spiral2.h5')
